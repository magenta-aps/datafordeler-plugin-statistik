...
public class BirthDataService extends StatisticsService {
    ...
    protected List<String> getColumnNames() {
        return Arrays.asList(new String[]{
                ...
                MOTHER_PNR, MOTHER_BIRTH_AUTHORIRTY, MOTHER_STATUS, MOTHER_MUNICIPALITY_CODE, MOTHER_LOCALITY_CODE, MOTHER_LOCALITY_NAME, MOTHER_ROAD_CODE, MOTHER_HOUSE_NUMBER, MOTHER_DOOR_NUMBER, MOTHER_BNR,
                FATHER_PNR, FATHER_BIRTH_AUTHORIRTY, FATHER_STATUS, FATHER_MUNICIPALITY_CODE, FATHER_LOCALITY_CODE, FATHER_LOCALITY_NAME, FATHER_ROAD_CODE, FATHER_HOUSE_NUMBER, FATHER_DOOR_NUMBER, FATHER_BNR
        });
